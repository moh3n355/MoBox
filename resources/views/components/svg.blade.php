<div class="login-wrapper" id="wrapper">
    <svg xmlns="http://www.w3.org/2000/svg" width="30rem" height="25rem" viewBox="0 0 550 450">
        <defs>
        ...
        <g id="legs" transform="translate(35,20)">
            <!-- پای چپ -->
            <g id="leftLeg" transform="translate(35,20)">
                <rect x="80" y="340" width="16" height="40" rx="8" fill="#222" />
                <ellipse cx="88" cy="390" rx="22" ry="8" fill="#fff" stroke="#222"
                    stroke-width="2" />
            </g>
            <!-- پای راست -->
            <g id="rightLeg" transform="translate(35,20)">
